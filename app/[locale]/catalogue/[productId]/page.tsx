    ...
    <main className="bg[#FAFAF7] bg-[#fde8e8]/95 text-[#1a1a1a] antialiased">
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <Link href={`/${locale}/catalogue`} className="text-sm text-[#555] transition hover:text-chocolate">
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm text-[#555]">
            {product.brand && <span className="rounded-full bg-cream px-3 py-1">{product.brand.name}</span>}
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_.9fr]">
          <div className="rounded-[28px] bg-white p-6 shadow-sm">
            <div className="relative mb-6 aspect-4/3 overflow-hidden rounded-[28px] bg-cream">
              <Image
                src={productImage}
                alt={product.name}
                width={800}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2 rounded-3xl bg-[#fafaf7] p-4">
                <p className="text-xs uppercase tracking-[0.3em] text-beige">{content.detail.price}</p>
                <p className="text-3xl font-semibold text-chocolate">{priceFormatted}</p>
              ...
              <div className="space-y-2 rounded-3xl bg-[#fafaf7] p-4">
                <p className="text-xs uppercase tracking-[0.3em] text-beige">{content.detail.stock}</p>
