...
export default function CheckoutForm({ cartItems }: CheckoutFormProps) {
  ...
  return (
    <div className="rounded-3xl border border-[#e8e4dc] bg-white p-8 shadow-sm">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="space-y-2 text-sm text-[#555]">
            ...
            <input
              ...
              className="w-full rounded-3xl border border-[#e8e4dc] bg-[#fafaf7] px-4 py-3 text-sm outline-none focus:border-chocolate focus:ring-2 focus:ring-beige-light"
              required
            />
          </label>
          <label className="space-y-2 text-sm text-[#555]">
      ...
      {status && (
        <div className="mt-4 rounded-3xl bg-cream p-4 text-sm text-[#1a1a1a]">
          <p>{status}</p>
