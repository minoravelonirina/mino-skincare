...
export function AuthContainer({ children }: AuthContainerProps) {
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#FAFAF7] p-4">
      <div className="absolute -left-32 -top-32 h-96 w-96 rounded-full bg-beige/15 blur-3xl" />
      <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-chocolate/10 blur-3xl" />
