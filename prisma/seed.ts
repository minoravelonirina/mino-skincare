...
async function main() {
  ...
  const product1 = await prisma.product.create({
    data: {
      ...
      images: JSON.stringify(["cleanser.jpg"]),
      skinType: "dry, normal",
  ...
  const product2 = await prisma.product.create({
    data: {
      ...
      images: JSON.stringify(["images/products/Creme_hydratante_apaisante.jpg"]),
      skinType: "dry",
  ...
  const product3 = await prisma.product.create({
    data: {
      ...
      images: JSON.stringify(["foam.jpg"]),
      skinType: "oily",
  ...
  const product4 = await prisma.product.create({
    data: {
      ...
      images: JSON.stringify(["sun_fluid.jpg"]),
      skinType: "all",
  ...
  const product5 = await prisma.product.create({
    data: {
      ...
      images: JSON.stringify(["hydro_boost.jpg"]),
  ...
  const product6 = await prisma.product.create({
    data: {
      ...
      images: JSON.stringify(["shampoo.jpg"]),
      skinType: "all",
